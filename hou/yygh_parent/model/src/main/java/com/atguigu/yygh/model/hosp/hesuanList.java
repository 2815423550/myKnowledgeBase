...
@TableName("hesuan_list")
/**
 * @TableName这个注解可以指定表名，但mybatis_plus默认类名为所要连接的表名，
 * 所以如果表名与实体类的类名一致则不需要用这个注解
**/
public class hesuanList extends BaseEntity {
