...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/loginuser?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
        dataSourceConfig.setDriverName("com.mysql.jdbc.Driver");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("1431891568");
