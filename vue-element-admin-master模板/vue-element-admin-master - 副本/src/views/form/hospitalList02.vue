<template>
  <div class="app-container">
    ...
    <el-table :data="list" stripe style="width: 100%">   <!-- @sort-change="ontime" -->   
...
<script>
import hesuanList from '@/api/hesuanList02'
export default {
  data() {
    return {
       current: 1, //当前页
  ...
  methods: {
    getList(page = 1) {
      this.current = page;
      hesuanList
        .gethesuanList(this.current, this.limit, this.searchObj)
        .then((res) => {
